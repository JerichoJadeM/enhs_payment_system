  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="main-color-bg" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="profile.php" class="list-group-item list-group-item-action bg-info text-light"><img src="assets/icons/pencil.svg" width="20px"> My Profile</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h1>
                    <img src="assets/icons/pencil.svg" alt="" width="32" height="32" title="Bootstrap">
                    My Profile</h1>
            </div>
        </div>
    </div>
                    ...
                    ?>
                      <div class="col-md-8">
                        <div class="card shadow p-3">
                          ...
                          <div class="card-body">
                            <form action="php_actions/process.php" method="GET" enctype="multipart/form-data">
                      ...
                      <div class="col-md-4 order-lg-last order-first">
                        <div class="card shadow p-3">
                          <div class="image">
                            <img src="assets/img/bg5.png" class="img-fluid mx-auto d-block" alt="background">
                          </div>
                          <div class="card-body text-center">
                            ...
                            <div class="row">
                              <div class="col">
                                <form action="php_actions/upload.php" method="POST" enctype="multipart/form-data">
