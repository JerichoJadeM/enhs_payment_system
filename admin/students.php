    ...
    <div class="main-color-bg" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <div id="demo2" class="collapse show">
          <a href="students.php" class="list-group-item list-group-item-action bg-info text-light pl-5"><img src="assets/icons/list-check.svg" width="20px"> All Students</a>
                              ...
                              <thead>
                                ...
                                <?php while($row = $result->fetch_assoc()): 
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    <a class="btn btn-info btn-sm"  type="submit" name="edit" href = "php_actions/editstudent.php?edit=<?php echo $row['LRN_number'];?>">Edit</a>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="delete" class="btn btn-outline-danger">Confirm</a>
            </form>
          </div>
        </div>
      </div>
