  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="main-color-bg" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <div id="demo" class="collapse show">
          <a href="activity.php" class="list-group-item list-group-item-action bg-info text-light pl-5"><img src="assets/icons/calendar-check.svg" width="20px"> Most Recent</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h1>
                    <img src="assets/icons/person.svg" alt="" width="32" height="32" title="Bootstrap">
                    User Activities</h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body">
                          <div class="table-responsive-sm">
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                <?php
                                  $act = $conn->query("SELECT * FROM activities GROUP BY id DESC LIMIT 20") or die($conn->error);
                                  $count = 1;
                                ?>
