    ...
    <div class="main-color-bg" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <div id="demo1" class="collapse show">
          <a href="users.php" class="list-group-item list-group-item-action bg-info text-light pl-5"><img src="assets/icons/list.svg" width="20px"> All Users</a>
          <a href="#" data-toggle="modal" data-target="#createAdmin" class="list-group-item list-group-item-action main-color-bg text-light pl-5"><img src="assets/icons/person-plus.svg" width="20px"> Add User</a>
        </div>
                              ...
                              <thead>
                                ...
                                <?php while($row = $result->fetch_assoc()): ?>
                                  <tr>
                                    ...
                                    <td class="text-left"><img class="rounded-circle" style="width:20px; height:20px;" src="../<?php echo $row['photo_file']?>" width="20px"><?php echo " " . $row['username']?></td>
