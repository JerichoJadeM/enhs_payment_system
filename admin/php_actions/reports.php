...
$pdf->Cell(0,55,'Annual Report',0,1,'C');
...
$pdf->SetFont('Times','',12);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////
    $userLogs = $conn->query("SELECT * FROM activities WHERE YEAR(activity_date) = YEAR(CURDATE()) ORDER BY activity_date DESC") or die($conn->error);
    $logCount = 1;
