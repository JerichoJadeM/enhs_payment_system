  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="../adv/students.php">Students <span class="sr-only">(current)</span></a>
      </li>
    </ul>
        ...
        <li class="nav-item">
          <div class="btn-group dropleft mt-1">
            ...
            <div class="dropdown-menu mt-3" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" role="button" href="ADVchangepass.php">Change Password</a>
    ...
    <section id="breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li><a href="../adv/students.php">/Students</a></li>
                                    ...
                                    <form action="edit-user.php" class="needs-validation" method="GET" novalidate>
                                      ...
                                      <div class="row float-right">
                                        <div class="col-md-12 mx-auto">
                                            <a href="../adv/students.php" type="button" class="btn btn-danger mt-1" name="cancel">Cancel</a>
