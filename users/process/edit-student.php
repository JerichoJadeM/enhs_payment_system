...
<link href="../../admin/assets/css/style.css" rel="stylesheet">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="../acc/index.php">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../acc/user.php">My Profile</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="../acc/students.php">Students <span class="sr-only">(current)</span></a>
      </li>
    </ul>
...
<?php
  ...
  <?php endif ?>
    <section id="breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="../acc/index.php">Home</a></li>
                <li><a href="../acc/students.php">/Students</a></li>
                ...
                <!--Edit Student Information ||-->
                    <div class="card shadow p-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <form action="edit-user.php" class="needs-validation" method="GET" novalidate>
                                      ...
                                      <div class="row float-right">
                                        <div class="col-md-12 mx-auto">
                                            <a href="../acc/students.php" type="button" class="btn btn-danger mt-1" name="cancel">Cancel</a>
