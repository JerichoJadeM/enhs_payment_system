        ...
        <li class="nav-item">
          <div class="btn-group dropleft mt-1">
            ...
            <div class="dropdown-menu mt-3" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" role="button" href="../process/changepassword.php">Change Password</a>
        ...
        <div class="container">
                    ...
                    <div class="card shadow">
                        <div class="card-heading main-color-bg">
                            <h6 class="card-title lead"><strong>Student List</strong></h6>
                        </div>
                        <div class="card-body">
                          <div class="row mx-auto">
                            ...
                            <div class="col mb-2 mt-0">
                              <a class="btn btn-outline-info shadow" type="button" target="_blank" href="../../admin/php_actions/student-list.php">
                            ...
                            <table id="studentTable" class="table table-hover nowrap table-sm" style="width:100%">  
                              <thead>
                                ...
                                <?php
                                  ...
                                  INNER JOIN payment on students.LRN_number = payment.LRN") or die($conn->error);
                                  $count = 1;
                                ?>
                                <?php while($row = $result->fetch_assoc()): 
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    <a class="btn btn-info btn-sm"  type="submit" name="edit" href = "../process/edit-student.php?edit=<?php echo $row['LRN_number'];?>">Edit</a>
